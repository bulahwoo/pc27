...
```{r pressure, echo=FALSE, fig.cap="Size distribution assessed by Bioanalyzer", out.width = '60%', fig.align = 'center'}
#![Bioanalyzer electropherogram of sequencing library!]("/home/nguyen/Downloads/Bioanalyzer_trace_PC-27.png")
...
The digital expression matrix using the Drop-seq protocol developed by the McCarroll Lab (https://github.com/broadinstitute/Drop-seq). Here are the programs used:
...
[Nikos Konstantinides](https://konstantinides-lab.com) suggested using [DropletUtils](https://doi.org/doi:10.18129/B9.bioc.DropletUtils) to identify the knee and inflection points. The y axis indicates the "total UMI count for each barcode."

```{r DropletUtils, eval = FALSE}
