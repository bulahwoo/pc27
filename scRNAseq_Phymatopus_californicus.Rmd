...
[FastQC](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/) was used for quality check. Output can be found [here](fastqc/read1/fastqc.md) and [here](fastqc/read2/fastqc.md).
...
```{r emptyDrops2, echo=FALSE, eval=FALSE}
...
[Seurat](https://satijalab.org/seurat) was used to generate the UMAP plot.

```{r umap-plot, warning=FALSE, message=FALSE}
